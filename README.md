...
- `Window.getComputedStyle`인자로 전달받은 요소의 모든 CSS 속성값을 담은 객체를 회신하는 데, 이 객체안에 담긴 CSS 속성의 개수가 많아, 이 중에서 default인 값들은 제외하고, 실제 custom된 style값만 추출하기 위하여 아래 사항을 시도하였습니다.
